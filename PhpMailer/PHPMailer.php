...
class PHPMailer
{
     ...
     *
     * @see http://sprain.ch/article/downloads/php-class-easypeasyics-create-ical-files-with-php/
        ...
        if ('en' !== $langcode) {
            ...
            if ($foundFile === false) {
                ...
                foreach ($lines as $line) {
                    ...
                    //See https://article.stevenlevithan.com/archives/match-quoted-string
                    $matches = [];
                    if (
                        preg_match(
